...
from tasks.setup_task import failed_result_task, setup_runtime, check_file_exists, setup_target_file_list, get_success_results, get_failed_results, end_runtime
...
with DAG(
    ...
    t_failed_ocr = failed_result_task.expand(file_info=t_ocr_failed_results)

    t_ocr_task >> [t_ocr_success_results, t_ocr_failed_results]
    t_ocr_success_results >> t_ocr_result_task
    t_ocr_failed_results >> t_failed_ocr
