...
from tasks.class_create_task import balance_false_images, build_balanced_dataset, image_data_augment
from tasks.no_train_lilt import no_train_lilt
...
with DAG(
    dag_id='lilt_document_classifier_no_lilt_V0.1',
    ...
    # 3-z. 실행순서
    t_class_create_setup_runtime >> dataset


    # # 4. 모델 학습
    # train = train_lilt(dataset,OUTPUT_MODEL_DIR)
    train = no_train_lilt(dataset,OUTPUT_MODEL_DIR)
