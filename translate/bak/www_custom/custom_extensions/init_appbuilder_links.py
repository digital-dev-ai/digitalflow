...
def init_appbuilder_links(app):
    ...
    appbuilder.add_link(name="DAGs",label="워크플로", href="Airflow.index")
    appbuilder.menu.menu.insert(0, appbuilder.menu.menu.pop())  # Place in the first menu slot
    appbuilder.add_link(name="Cluster Activity",label="군집분석", href="Airflow.cluster_activity")
    appbuilder.menu.menu.insert(1, appbuilder.menu.menu.pop())  # Place in the second menu slot
    appbuilder.add_link(name="Datasets", label="데이터셋", href="Airflow.datasets")
